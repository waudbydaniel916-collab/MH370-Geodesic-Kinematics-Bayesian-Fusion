...
narrower then found by the ATBS. This Repository contains an oceanographic data model, showcasing the calculated border, A KML file 
for water discovery vehicles and for Google Earth as a showcase of location in extra geographical context, and the highest matching 
coordinate points to boundary the wreckage of MH370 from this calculation.
